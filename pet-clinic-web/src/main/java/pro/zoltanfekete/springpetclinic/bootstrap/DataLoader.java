...
import pro.zoltanfekete.springpetclinic.model.*;
...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        Specialty savedDentirstry = specialtyService.save(dentistry);

        Owner owner1 = new Owner();
        owner1.setFirstName("Michael");
        owner1.setLastName("Weston");
        owner1.setAddress("123 Beverly");
        owner1.setCity("Hills");
        ...
        owner2.setAddress("123 Beverly");
        owner2.setCity("Hills");
        ...
        vet1.getSpecialities().add(savedDentirstry);
